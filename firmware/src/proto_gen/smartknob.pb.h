...
#ifndef PB_PB_PROTO_SMARTKNOB_PB_H_INCLUDED
#define PB_PB_PROTO_SMARTKNOB_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _PB_StrainRawOffset
{
   float A;
   float B;
   float C;
...
typedef struct _PB_PersistentConfiguration
{
   ...
   bool has_strain_offset;
   PB_StrainRawOffset strain_offset; /* <-- Add this line */
...
#define PB_PersistentConfiguration_init_default {0, false, PB_MotorCalibration_init_default, false, PB_StrainCalibration_init_default, false, PB_StrainRawOffset_init_default}
#define PB_MotorCalibration_init_default {0, 0, 0, 0}
#define PB_StrainCalibration_init_default {0, 0}
#define PB_StrainRawOffset_init_default {0, 0, 0, 0}
...
#define PB_PersistentConfiguration_init_zero {0, false, PB_MotorCalibration_init_zero, false, PB_StrainCalibration_init_zero, false, PB_StrainRawOffset_init_zero}
#define PB_MotorCalibration_init_zero {0, 0, 0, 0}
#define PB_StrainCalibration_init_zero {0, 0}
#define PB_StrainRawOffset_init_zero {0, 0, 0, 0}
...
#define PB_StrainRawOffset_A_tag 1
#define PB_StrainRawOffset_B_tag 2
#define PB_StrainRawOffset_C_tag 3
#define PB_StrainRawOffset_D_tag 4
...
#define PB_PersistentConfiguration_strain_offset_tag 4
...
#define PB_PersistentConfiguration_FIELDLIST(X, a) \
   ...
   X(a, STATIC, OPTIONAL, MESSAGE, strain_offset, 4)
...
#define PB_PersistentConfiguration_strain_offset_MSGTYPE PB_StrainRawOffset
...
#define PB_StrainRawOffset_FIELDLIST(X, a) \
   X(a, STATIC, SINGULAR, FLOAT, A, 1)     \
   X(a, STATIC, SINGULAR, FLOAT, B, 2)     \
   X(a, STATIC, SINGULAR, FLOAT, C, 3)     \
   X(a, STATIC, SINGULAR, FLOAT, D, 4)
#define PB_StrainRawOffset_CALLBACK NULL
#define PB_StrainRawOffset_DEFAULT NULL
   ...
   extern const pb_msgdesc_t PB_StrainRawOffset_msg;
...
#define PB_StrainRawOffset_fields &PB_StrainRawOffset_msg
...
#define PB_StrainRawOffset_size 20
#define PB_PersistentConfiguration_size 69
